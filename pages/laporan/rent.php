...
foreach ($tables as $table => $name) {
    $items = $db->query("SELECT ID, Code, Description, Notes, Status, RentDocNumber, CreatedDate, '$table' as Tbl, '$name' as Cat FROM $table WHERE Status = 1 ORDER BY CreatedDate DESC")->fetchAll();
...
$pageTitle = 'Laporan Inventaris Status Rent';
$activePage = 'laporan_rent';
include '../../includes/header.php';
?>

<div class="card">
    <div class="card-header">
        <span class="card-title"><i class="fas fa-hand-holding"></i> Inventaris Status Rent</span>
        <span class="badge badge-rent"><?php echo count($allItems); ?> Item</span>
    </div>
    <div class="card-body">
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr><td colspan="6" class="empty-state" style="padding: 40px;">
                        <i class="fas fa-inbox"></i><h3>Tidak ada data</h3><p>Belum ada inventaris dengan status Rent</p>
                    </td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
